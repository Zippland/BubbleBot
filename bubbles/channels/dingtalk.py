...
from bubbles.config.schema import DingTalkConfig
...
class BubblesDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Bubbles channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Bubbles via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    def __init__(self, config: DingTalkConfig, bus: MessageBus, session_mode: str = "channel"):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = BubblesDingTalkHandler(self)
    ...
    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by BubblesDingTalkHandler).
