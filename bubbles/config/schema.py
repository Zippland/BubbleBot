...
class WeChatConfig(Base):
    """WeChat channel configuration using wcferry."""
...
class ChannelsConfig(Base):
    ...
    session_mode: str = "channel"  # "channel" (default), "user", or "global"
...
class Config(BaseSettings):
    """Root configuration for bubbles."""
    ...
    model_config = ConfigDict(env_prefix="BUBBLES_", env_nested_delimiter="__")
